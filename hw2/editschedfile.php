 ...
 <body>
  <form action = "process.php"
      ...
      if(mysqli_connect_errno()) {
        ...
        //make the user rows for the table
        foreach ($users as $oneuser => $hisemail):
            ...
            if (in_array("none", $timesofoneuser)):
              ...
              if ($hisemail == $email):
                if (!in_array($tmpctr, $timesofoneuser)):
    						  echo "<td><input type=\"checkbox\" name=\"editedtime[] \" value=\"". $tmpctr . "\" /></td>";
    					  else:
    						  echo "<td><input type=\"checkbox\" name=\"editedtime[] \" value=\"". $tmpctr . "\" checked /></td>";
    					  endif;
              else:
                //if email not the same as url email then just keep going with normal table
                if (in_array("none", $timesofoneuser)):
                  echo "<td> </td>";
                else:
                  if (in_array($tmpctr, $timesofoneuser)):
          ...
          if ($hisemail == $email):
    				echo "<td> <input type=\"submit\" name = \"submittimes\" value = \"Submit\" > </td>";
    			else:
    				echo "<td> </td>";
    			endif;
    		endforeach;
